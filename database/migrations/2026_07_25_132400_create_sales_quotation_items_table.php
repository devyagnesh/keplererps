...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('sales_quotation_items', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sales_quotation_id')->index();
            ...
            $table->foreign('sales_quotation_id', 'sqi_sq_id_fk')->references('id')->on('sales_quotations')->cascadeOnDelete();
            $table->foreign('item_id', 'sqi_item_id_fk')->references('id')->on('items')->restrictOnDelete();
            $table->foreign('uom_id', 'sqi_uom_id_fk')->references('id')->on('uoms')->restrictOnDelete();
        });
    }
