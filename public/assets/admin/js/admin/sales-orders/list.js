...
$(function () {
    var table = $('#masterTable').DataTable({
        ...
        columns: [
            ...
            { data: 'customer', orderable: false }, { data: 'warehouse', orderable: false },
    ...
    $(document).on('click', '.btn-delete-master', function () {
        ...
        Swal.fire({ title: 'Delete draft sales order?', icon: 'warning', showCancelButton: true, confirmButtonText: 'Delete' }).then(function (result) {
