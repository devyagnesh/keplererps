/**
 * Production plan listing DataTable.
 */
$(function () {
    var table = $('#masterTable').DataTable({
        ...
        columns: [
            ...
            { data: 'horizon', orderable: false }, { data: 'lines', orderable: false },
    ...
    $(document).on('click', '.btn-delete-master', function () {
        ...
        Swal.fire({ title: 'Delete draft plan?', icon: 'warning', showCancelButton: true, confirmButtonText: 'Delete' }).then(function (result) {
