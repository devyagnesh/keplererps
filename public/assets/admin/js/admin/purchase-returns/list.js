/**
 * Purchase return listing DataTable.
 */
$(function () {
    var table = $('#masterTable').DataTable({
        ...
        columns: [
            ...
            { data: 'supplier', orderable: false }, { data: 'goods_receipt', orderable: false },
            { data: 'reason', orderable: false }, { data: 'grand_total' },
    ...
    $(document).on('click', '.btn-delete-master', function () {
        ...
        Swal.fire({ title: 'Delete draft return?', icon: 'warning', showCancelButton: true, confirmButtonText: 'Delete' }).then(function (result) {
